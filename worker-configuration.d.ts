/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d4f4902388d120b70e369deddc4b2abf)
...
interface __BaseEnv_Env {
	...
	// Staging-bryter, også håndjustert (fra literal til valgfri string): er den
	// satt, omdirigerer sendEmail ALL e-post dit. Tom i prod, Sindre i staging.
	EMAIL_REDIRECT_ALL_TO?: string;
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		DB: D1Database;
		EMAIL: SendEmail;
		CALENDAR_EMBED_URL: "https://calendar.google.com/calendar/embed?src=0ieontn6bgp0f9loh031ba9hgc%40group.calendar.google.com&ctz=Europe%2FOslo&wkst=2&hl=no";
		EMAIL_REDIRECT_ALL_TO: "sindre.ryland@gmail.com";
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		ADMIN_EMAIL: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CALENDAR_EMBED_URL" | "EMAIL_REDIRECT_ALL_TO" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "ADMIN_EMAIL">> {}
}
