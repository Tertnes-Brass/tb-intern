...
const chunks = []
let current = ''
for (let line of parts.join('\n').split('\n')) {
  // En enkelt linje kan være lengre enn grensen. Bevar også hele emoji
  // (UTF-16-surrogatpar) når en slik linje må deles midt i teksten.
